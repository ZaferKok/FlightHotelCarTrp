@ReservationNegative
Feature: Room reservation negative

  Scenario: As a manager, I should not be able to save a room reservation
            with entering invalid data into all boxes
    ...
    And click on Contact Email and type invalid email ""
